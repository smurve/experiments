...
from mnist_simple_convnet import Model
...
def main(_):
    ...
    def get_input_tensor(features):
        ...
        :return: the extracted tensor, if it is a dictionary, else the unchanged input param
        """
        extr = features
    ...
    model_function = create_spec_provider(
        lambda: Model(data_format), get_input_tensor)
